--------------------------------------------------------------------------
-- display_driver7seg_digit - module responsible for driving a LED display
--
...
begin
    ...
    --------------------------------------------------------------------    
    -- asynchronní proces
p_mux : process(s_cnt, data0_i, data1_i, data2_i, data3_i, dp_i) -- zmìna zpùsobí spuštìní procesu
    begin
        case s_cnt is
            when "11" =>
                s_hex <= data3_i;
